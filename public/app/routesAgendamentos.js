...
app.config(function ($routeProvider, $locationProvider, $ocLazyLoadProvider) {
    $routeProvider
        ...
        .when('/prestador/:id',             { templateUrl: 'app/views/Agendamentos/usuario/view_prestador.html'+'?t='+ date, title: '', controller: 'AgendamentoCtrl',                  resolve: testeOCLazyLoad("AgendamentoCtrl", "") })
        ...
        .when('/profissional/financeiro',       { templateUrl: 'app/views/Agendamentos/profissional/listagem_receitas.html' + '?t=' + date, title: '', controller: 'ProfissionalCtrl',      resolve: { lazy: ['$ocLazyLoad', function ($ocLazyLoad) { return $ocLazyLoad.load([{ name: 'Profissional', files: ['app/controllers/ProfissionalCtrl.js'] }]); }]} })
        .when('/profissional/agenda_dia',       { templateUrl: 'app/views/Agendamentos/profissional/lista_agendamentos_dia.html' + '?t=' + date, title: '', controller: 'ProfissionalCtrl', resolve: { lazy: ['$ocLazyLoad', function ($ocLazyLoad) { return $ocLazyLoad.load([{ name: 'Profissional', files: ['app/controllers/ProfissionalCtrl.js'] }]); }]} })
        .when('/profissional/apontamento/:id',  { templateUrl: 'app/views/Agendamentos/profissional/view_agendamento.html' + '?t=' + date, title: '', controller: 'ProfissionalCtrl',       resolve: { lazy: ['$ocLazyLoad', function ($ocLazyLoad) { return $ocLazyLoad.load([{ name: 'Profissional', files: ['app/controllers/ProfissionalCtrl.js'] }]); }]} })
        ...
        .when('/gyms',                      { templateUrl: 'app/views/Agendamentos/Gym/gyms.html'+'?t='+ date, title: '', controller: 'GymCtrl',                                        resolve: { lazy: ['$ocLazyLoad', function ($ocLazyLoad) { return $ocLazyLoad.load([{ name: 'Gym', files: ['app/controllers/Agentamentos/GymCtrl.js'] }]); }]} })
        .when('/gym/:id',                   { templateUrl: 'app/views/Agendamentos/Gym/dashboard.html'+'?t='+ date, title: '', controller: 'GymCtrl',                                   resolve: { lazy: ['$ocLazyLoad', function ($ocLazyLoad) { return $ocLazyLoad.load([{ name: 'Gym', files: ['app/controllers/Agentamentos/GymCtrl.js'] }]); }]} })
        .when('/gym/treinos',               { templateUrl: 'app/views/Agendamentos/Gym/treinoUsuario.html'+'?t='+ date, title: '', controller: 'GymCtrl',                               resolve: { lazy: ['$ocLazyLoad', function ($ocLazyLoad) { return $ocLazyLoad.load([{ name: 'Gym', files: ['app/controllers/Agentamentos/GymCtrl.js'] }]); }]} })
