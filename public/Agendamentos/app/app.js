...
app.config(function ($routeProvider, $locationProvider, $ocLazyLoadProvider) {
    $routeProvider
        ...
        .when('/home',          { templateUrl: 'app/views/home.html', title: '' })
        .when('/perfil',        { templateUrl: 'app/views/usuario/perfil.html', title: '', controller: 'PerfilCtrl' })
        ...
        .when('/admin/financeiro',          { templateUrl: 'app/views/financeiro/entrada.html'+'?t='+ date, title: '', controller: 'FinanceiroCtrl' })
        
        .when('/gyms',                      { templateUrl: 'app/views/Gym/gyms.html'+'?t='+ date, title: '', controller: 'GymCtrl' })
        .when('/gym/:id',                   { templateUrl: 'app/views/Gym/dashboard.html'+'?t='+ date, title: '', controller: 'GymCtrl' })
        .when('/gym/treinos',               { templateUrl: 'app/views/Gym/treinoUsuario.html'+'?t='+ date, title: '', controller: 'GymCtrl' })

        .when('/configs',                   { templateUrl: 'app/views/sistema/configuracoes.html'+'?t='+ date, title: '', controller: 'SistemaCtrl' })
        .when('/plans',                     { templateUrl: 'app/views/sistema/planos.html'+'?t='+ date, title: '', controller: 'SistemaCtrl' })
        .when('/plans/substription',        { templateUrl: 'app/views/sistema/subscription.html'+'?t='+ date, title: '', controller: 'SistemaCtrl' })
        .when('/plans/accepted',            { templateUrl: 'app/views/sistema/plans/acceptedPlan.html'+'?t='+ date, title: '', controller: 'SistemaCtrl' })
        .otherwise({ templateUrl: 'app/views/sistema/Erro404.html' });
